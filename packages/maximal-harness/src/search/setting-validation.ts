...
import type { ConnectorSettingField, ConnectorSettingValue } from "../search.js"
...
export function settingValueError(
  ...
  return parsed.success ?
      undefined
    : parsed.error.issues[0]?.message ?? `Invalid ${field.label}.`
}
...
function isEmptySettingValue(value: ConnectorSettingValue): boolean {
