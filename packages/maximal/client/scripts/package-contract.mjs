/**
 * Native-package decisions shared by Forge and the packaged-app verifier.
 *
 * Plain ESM keeps the verifier runnable under Node. The declaration beside this
 * file supplies types to `forge.config.ts`.
 */
 ...
 *
 * This reads the fields npm publishes, so it needs no package-specific
 * knowledge.
 *
 ...
 * dependency that the installer hoists or places beside a pnpm link must be
 * materialized explicitly at its Node resolution path.
 *
